...
# # client_slack = WebClient(token='xoxp-1216139827667-1209198857638-2242013820023-7dd447034fccb7440f7b10ce935ea312') # slack ở MM<3
...
# #     client_slack.chat_postMessage(channel='minchan-testing', text=str("testing"))
